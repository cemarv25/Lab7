...
public class GreetingRestControllerTest {
	...
	@Test
	public void givenAGoodbyeRequest_whenEmptyName_thenByeWorld() throws Exception {
	...
	@Test
	public void givenAGoodbyeRequest_whenProvidedName_thenByeName() throws Exception {
